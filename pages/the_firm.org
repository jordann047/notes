...
***** The modern story of the digital age has proven that innovation does indeed result in booms and busts.
***** Booms create speculative bubbles.
***** Schumpeter saw that bubbles can productive and can prove necessary for the exploration of new technologies in the new economic space that those technologies create.
****** For example, Amazon took $2.2 billion to get to positive cash flow, it could not have done this if not for the bubble environment.
***** Creative Destruction
****** Entrepreneurship creates something new, whilst simultaneously destroying something old.
****** The modern term is 'disruption'.
****** Any attempt to try and stifle the process of creative disruption would ultimately result in less growth and less prosperity.
***** Modern Schumpeterian economics has merged with Keynesian thought and see's the state as important to innovation, due to the public investment of the state into scientific research.
****** For innovation to flourish, governments therefore need to take an active role that goes beyond fixing market failures.
